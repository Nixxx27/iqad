...
<div class="container">
    <div class="row" style="margin-bottom:50px">
        <div class="col-md-offset-3 col-md-5 col-sm-offset-3 col-sm-7 bg_white"
            ...
            <form method="POST" action="/QADapps/register">
                {!! csrf_field() !!}
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td>
                            {!! Form::text('email',null,['class'=>'form-control bg','value'=>"{{ old('email') }}" ]) !!}
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            {!! Form::password('password_confirmation',['class'=>'form-control bg']) !!}
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td></td>
                        <td >
                            {!! Form::submit('Register',['class'=>'btn btn-primary btn-md']); !!}
                        </td>
                    </tr>
                </table>
            </form>
